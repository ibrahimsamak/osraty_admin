...
var map = {
	...
	"./editors/editors.module": [
		...
		"app-pages-pages-module~editors-editors-module",
		"common",
		"editors-editors-module"
	],
	"./forms/forms.module": [
...
var StateService = /** @class */ (function () {
    ...
    StateService.prototype.updateSidebarIcons = function (direction) {
        ...
        var isRtl = direction === _nebular_theme__WEBPACK_IMPORTED_MODULE_3__["NbLayoutDirection"].RTL;
        var startIconClass = isRtl ? 'nb-layout-sidebar-right' : 'nb-layout-sidebar-left';
        var endIconClass = isRtl ? 'nb-layout-sidebar-left' : 'nb-layout-sidebar-right';
...
var NB_MODULES = [
    ...
    _nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbBadgeModule"]
];
var COMPONENTS = [
...
var AppComponent = /** @class */ (function () {
    function AppComponent(analytics, dir) {
        this.analytics = analytics;
        this.d = _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbLayoutDirection"].RTL;
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_core_utils_analytics_service__WEBPACK_IMPORTED_MODULE_2__["AnalyticsService"], _nebular_theme__WEBPACK_IMPORTED_MODULE_0__["NbLayoutDirectionService"]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ng-select/ng-select */ "./node_modules/@ng-select/ng-select/fesm5/ng-select.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
...
/* harmony import */ var _pages_service_constant_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./pages/service/constant.service */ "./src/app/pages/service/constant.service.ts");
...
/* harmony import */ var _pages_service_custom_format_date_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./pages/service/custom/format-date.service */ "./src/app/pages/service/custom/format-date.service.ts");
/* harmony import */ var _nebular_theme__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @nebular/theme */ "./node_modules/@nebular/theme/index.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["NgModule"])({
            ...
            imports: [
                ...
                angular2_toaster__WEBPACK_IMPORTED_MODULE_12__["ToasterModule"].forRoot(),
            ...
            providers: [
                ...
                _pages_service_constant_service__WEBPACK_IMPORTED_MODULE_11__["ConstantService"],
                _pages_service_custom_format_date_service__WEBPACK_IMPORTED_MODULE_13__["FormatDateService"],
...
/***/ "./src/app/pages/service/constant.service.ts":
/*!***************************************************!*\
  !*** ./src/app/pages/service/constant.service.ts ***!
  \***************************************************/
...
var ConstantService = /** @class */ (function () {
    ...
    ConstantService.prototype.getDeliveryData = function () {
        return this.http.get('/constant/delivery');
    };
    ConstantService.prototype.DeleteDeliveryData = function (id) {
        var httpOptions = {
    ...
    ConstantService.prototype.UpdateDeliveryData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateDeliveryData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getDeliveryOptionsData = function () {
        return this.http.get('/constant/DeliveryOption');
    };
    ConstantService.prototype.DeleteDeliveryOptionsData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateDeliveryOptionsData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateDeliveryOptionsData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getBuyUnitsData = function () {
        return this.http.get('/constant/BuyUnits');
    };
    ConstantService.prototype.DeleteBuyUnitsData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateBuyUnitsData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateBuyUnitsData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getBuyOptionsData = function () {
        return this.http.get('/constant/BuyOptions');
    };
    ConstantService.prototype.DeleteBuyOptionsData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateBuyOptionsData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateBuyOptionsData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getContactOptionData = function () {
        return this.http.get('/constant/ContactOption');
    };
    ConstantService.prototype.DeleteContactOptionData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateContactOptionData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateContactOptionData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getSocialOptionData = function () {
        return this.http.get('/constant/SocialOption');
    };
    ConstantService.prototype.DeleteSocialOptionData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateSocialOptionData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateSocialOptionData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getStaticPagenData = function () {
        return this.http.get('/constant/staticpage');
    };
    ConstantService.prototype.getSingleStaticPagenData = function (id) {
        return this.http.get("/constant/staticpage/" + id);
    };
    ConstantService.prototype.DeleteStaticPageData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateStaticPageData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateStaticPageData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateCategoryData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getCategoryData = function () {
        return this.http.get('/product/category');
    };
    ConstantService.prototype.getSingleCategoryData = function (id) {
        return this.http.get("/product/category/" + id);
    };
    ConstantService.prototype.DeleteCategoryData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateCategoryData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateSubCategoryData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getSubCategoryData = function () {
        return this.http.get('/product/subcategory');
    };
    ConstantService.prototype.getSubCategoryDataByCategoryId = function (id) {
        return this.http.get("/product/subcategorybycategoryid/" + id);
    };
    ConstantService.prototype.getSingleSubCategoryData = function (id) {
        return this.http.get("/product/subcategory/" + id);
    };
    ConstantService.prototype.DeleteSubCategoryData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateSubCategoryData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateSupplierData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getSupplierData = function () {
        return this.http.get('/product/supplier');
    };
    ConstantService.prototype.getSingleSupplierData = function (id) {
        return this.http.get("/product/supplier/" + id);
    };
    ConstantService.prototype.DeleteSupplierData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateSupplierData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateProductData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getProductData = function () {
        return this.http.get('/product/product');
    };
    ConstantService.prototype.getProductDataBySubCategoryId = function (id) {
        return this.http.get("/product/productbysubcategoryid/" + id);
    };
    ConstantService.prototype.getSingleProductData = function (id) {
        return this.http.get("/product/product/" + id);
    };
    ConstantService.prototype.DeleteProductData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateProductData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.DeleteOneImage = function (img) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.CreateSupplierProductData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getSupplierProductData = function () {
        return this.http.get('/Supplier/supplierproducts');
    };
    ConstantService.prototype.getSingleSupplierProductData = function (id) {
        return this.http.get("/Supplier/supplierproducts/" + id);
    };
    ConstantService.prototype.DeleteSupplierProductData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateSupplierProductData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getSupplierProductBySeacrhData = function (key) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getSupplierProductBySubCategory = function (id, supid) {
        return this.http.get("/Supplier/supplierproductsBySubCategoryId/" + id + "/" + supid);
    };
    ConstantService.prototype.getsupplierproductsBySupplierId = function (id) {
        return this.http.get("/Supplier/supplierproductsBySupplierId/" + id);
    };
    ConstantService.prototype.CreateAdvtData = function (conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.getAdvData = function () {
        return this.http.get('/Adv/adv');
    };
    ConstantService.prototype.getSingleAdvData = function (id) {
        return this.http.get("/Adv/adv/" + id);
    };
    ConstantService.prototype.DeleteAdvData = function (id) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
    ...
    ConstantService.prototype.UpdateAdvData = function (id, conent) {
        var httpOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({
                'Content': "application/json",
                'Accept': 'application/json',
...
/***/ "./src/app/pages/service/custom/format-date.service.ts":
/*!*************************************************************!*\
  !*** ./src/app/pages/service/custom/format-date.service.ts ***!
  \*************************************************************/
...
//     }
//   }
var FormatDateService = /** @class */ (function () {
    function FormatDateService() {
        this.DT_FORMAT = 'MM/DD/YYYY';
    }
    FormatDateService.prototype.parse = function (value) {
        if (value) {
            value = value.trim();
            var mdt = moment__WEBPACK_IMPORTED_MODULE_0__(value, this.DT_FORMAT);
        }
        return null;
    };
    FormatDateService.prototype.format = function (date) {
        if (!date)
            return new Date();
        var mdt = moment__WEBPACK_IMPORTED_MODULE_0__([date.year, date.month - 1, date.day]).toDate();
        return mdt;
    };
    return FormatDateService;
}());
...
module.exports = __webpack_require__(/*! /Users/ibrahimm.samak/Desktop/liken/CPanel-API/admin/src/main.ts */"./src/main.ts");
